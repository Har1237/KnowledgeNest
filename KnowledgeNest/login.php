            ...
            <div class="col-lg-12 col-xl-6">
                  <form action="" method="post" enctype="multipart/form-data">           <!-- enctype is include because we insert image in form -->
                      ...
                      <div class="mt-4 pt-2">
                        ...
                        <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an acount ?<a href="user_registration.php" class="text-danger"> Register</a></p>
                      </div>
  ...
  if($row_count>0){
    ...
    if(password_verify($user_password,$row_data['user_password'])){
      if($row_count==1 and $row_count_cart==0){
        $_SESSION['username']=$user_username;
        echo "<script>alert('You have log in successfully')</script>";
