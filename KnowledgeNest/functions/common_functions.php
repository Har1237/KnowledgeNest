...
function get_unique_categories(){
    ...
    if($num_of_rows==0){
        echo "<h2 class='text-center text-danger mx-5'>No Stock for this category</h2>";
    }
...
function get_unique_brands(){
    ...
    if(isset($_GET['brand'])){
     ...
     $num_of_rows=mysqli_num_rows($result_query);
    if($num_of_rows==0){
        echo "<h2 class='text-center text-danger mx-5'>This brand is not available for service</h2>";
    }
...
//displaying brands inside sidenav
function getbrands(){
    global $con;
...
//function to displaying categories sidevan
...
function search_products(){
    ...
    if(isset($_GET['search_data_product'])){
       ...
       $search_query="Select * from `products` where product_title like '%$user_search_value%'";
     $result_query=mysqli_query($con,$search_query);
     $num_of_rows=mysqli_num_rows($result_query);
     if($num_of_rows==0){
         echo "<h2 class='text-center text-danger mx-4 my-3'>No result match.No product available on this category</h2>";
     }
    while($row=mysqli_fetch_assoc($result_query)){
      $product_id=$row['product_id'];
      $product_title=$row['product_title'];
